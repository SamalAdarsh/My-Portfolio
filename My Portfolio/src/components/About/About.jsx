      ...
      <div className="relative z-10 flex flex-col-reverse md:flex-row justify-between items-center gap-10 md:gap-12 lg:gap-24">
        ...
        <div className="w-full md:w-1/2 lg:w-[50%] text-center md:text-left mt-8 sm:mt-12 md:mt-0 z-10">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            A Full Stack Developer with 3+ years of experience building and
            supporting web applications used in production. Ex- perienced in
            developing user interfaces, backend services, APIs, database-driven
            workflows, and real-time features from development through
            deployment. Worked on applications that automate business processes,
            improve per- formance, and reduce manual effort. Comfortable working
            across the stack and collaborating with cross-functional teams to
